...
void deposito(Pagamentos cliente)
{
  ...
  if(pagamento == 1){
    ...
    switch(escolha){
      case 1: ((cliente.saldo) - (cliente.valor) <= cliente.limite)  ? print("Você ultrapassou seu limite, infelizmente seu deposito não pode ser feito.") : cliente.pagarpix(); break;
      case 2: cliente.pagarted(); break;
      case 3: ((cliente.saldo) - (cliente.valor) <= cliente.limite)  ? print("Você ultrapassou seu limite, infelizmente seu deposito não pode ser feito.") : cliente.pagarboleto(); break;
    }
...
void main() {
  ...
  */
  ...
  while(true){
    ...
    switch(escolha){
      case 1: gerador_boleto(cliente); break;
      // case 2: imprime_boleto(); break;
      // case 3: pagar_boleto(); break;
      case 4: deposito(cliente); break;
      case 5: exit(exitCode);
    }
  }
}
